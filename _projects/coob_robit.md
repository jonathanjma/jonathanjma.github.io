...
<div class="row">
    <div class="col-sm my-3 text-center">
        {% include figure.liquid path="assets/img/cube_robot/coob_robit.png" title="coob robit project" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row">
    <div class="col-sm my-3 text-center">
        {% include figure.liquid path="assets/img/cube_robot/cube_vision.png" title="cube opencv" width="75%" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row">
    <div class="col-sm my-3 text-center">
        {% include figure.liquid path="assets/img/cube_robot/cube_solve.gif" title="cube solve" width="75%" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
