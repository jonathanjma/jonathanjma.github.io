...
<div class="row">
    <div class="col-sm my-3 text-center">
        {% include figure.liquid path="assets/img/clipboard.png" title="clipboard icon" height="150vw" %}
    </div>
</div>
...
<div class="row">
    <div class="col-sm my-3 text-center">
        {% include figure.liquid path="assets/img/clipboard_ios.png" title="clipboard shortcut" width="40%" %}
    </div>
</div>
...
<div class="row">
    <div class="col-sm my-3 text-center">
        {% include figure.liquid path="assets/img/clipboard_python.png" title="clipboard python script" width="40%" %}
    </div>
</div>
